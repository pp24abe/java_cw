        ...
        do {
            ...
            if (option == 1) {
                ...
                if (choice == 1) {
                    ...
                    bookings.bookAppointment(patient, selectedDoctor, chosenAppointment.getDate(), chosenAppointment.getTime());
                ...
                String patientName = user_input.nextLine();
                patient p = bookings.searchBypatname(patientName);

                if (p == null) {
                    System.out.println("❌ No appointment found for the given patient.");
                    continue;
                }
            ...
            // Ensure answer is set for the loop
            if (option != 5 ) {
                answer = "Y";  // Prevent infinite loops
            }
